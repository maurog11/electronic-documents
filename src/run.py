...
from app.routes.docs.emails.emails_route import api as ns_emails
...
from app.routes.sends_docs.events.events_route import api as ns_events
...
from app.routes.receipts.shoppings.shoppings_route import api as ns_shoppings
...
from app.routes.mail_service.mail_route import api as routes_mail
...
api.add_namespace(ns_emails, path='/emails')
...
api.add_namespace(ns_shoppings, path='/shoppings')
...
api.add_namespace(routes_mail, path='/mail')
