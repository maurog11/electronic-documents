...
api = Namespace("Notas", description="Operaciones relacionadas con Notas")
...
BillingPeriod = api.model("BillingPeriod", {
    ...
    'InvoiceAuthorization': fields.String(required=True, description="Resolucion DIAN de factura"),
...
Additional = api.model("AdditionalN", {
      'CUDE': fields.String(required=True, description="Codigo unico de f.e"),
      'Contingency': fields.String(required=True, description="N= No contingencia S= Si contingencia"),
      'SendEmail': fields.Boolean(required=True, description="Bandera que indica si se envia el documento al email, True o False"),
      ...
      'DianTechnicalKey': fields.String(required=True, description="Se obtiene del endpoint Numbering con el nit y el diansoftwareid"),
...
DocumentReferences = api.model("DocumentReferences", {
    ...
    'IssueDate': fields.String(required=False, description="Fecha de creacion documento"),
    ...
    'DocumentReferredCUFE': fields.String(required=False, description="CUFE de documento referido")
})
...
IdentificationAdditionalCustomers = api.model("IdentificationAdditionalCustomers", {
    ...
    'CountryCode': fields.String(required=False, description="CO= Colombia, para los demas codigos en la tabla 13.4.1 resolucion 12"),
    'CheckDigit': fields.String(required=False, description="Digito de verificacion")
})
AdditionalCustomer = api.model("AdditionalCustomers", {
    ...
    'ParticipationPercentage': fields.String(required=False, description="Porcentaje de participacion")
})
