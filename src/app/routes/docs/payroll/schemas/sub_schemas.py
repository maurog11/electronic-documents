...
api = Namespace("Nominas", description="Operaciones relacionadas con Nominas")


FechasPagos = api.model("FechasPagos", {
    'FechaPago': fields.String(required=True, description="Debe ir la fecha de pago del documento. Considerando zona horaria de Colombia (-5), en formato AAAA-MM-DD")
})

Periodo = api.model("Periodo", {
    'FechaIngreso': fields.String(required=True, description="Se debe indicar la Fecha de ingreso del trabajador a la empresa, en formato AAAA-MM-DD"),
    'FechaLiquidacionInicio': fields.String(required=True, description="Se debe indicar la Fecha de Inicio del Periodo de Liquidación del documento, en formato AAAA-MM-DD"),
    'FechaLiquidacionFin': fields.String(required=True, description="Se debe indicar la Fecha de Fin del Periodo de Liquidación del documento, en formato AAAA-MM-DD"),
...
InfoGeneralNotas = api.model("InformacionGeneralNotas", {
    ...
    'FechaGenPredecesor': fields.String(required=True, description="Debe ir la fecha del documento a Reemplazar, en formato AAAA-MM-DD"),
...
VacacionesComunes = api.model("VacacionesComunes", {
    ...
    'FechaInicio': fields.String(required=False, description="En formato AAAA-MM-DD"),
    'FechaFin': fields.String(required=False, description="En formato AAAA-MM-DD"),
})
...
Devengados = api.model("Devengados", {
    ...
    'Transporte': fields.Nested(Transporte),
