...
from app.routes.consecutives.consecutivepayroll import api_consecutivepayroll as api
from app.controllers import ConsecutivePayRollController as Controller
