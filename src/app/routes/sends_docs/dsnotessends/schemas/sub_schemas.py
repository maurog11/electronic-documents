...
api = Namespace("Envios notas documento soporte", description="Operaciones relacionadas con envios de notas documento soporte")
...
AdditionalNDS = api.model("AdditionalNDS", {
      'CUDE': fields.String(required=True, description="CUDE"),
