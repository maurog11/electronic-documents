...
api = Namespace("Envios notas", description="Operaciones relacionadas con envios de notas")
...
Additional = api.model("AdditionalN", {
      'CUDE': fields.String(required=True, description="Codigo unico de nota debito o credito"),
...
PaymentMeans = api.model("PaymentMean", {
    ...
    'Mean': fields.String(required=False, description="10= Efectivo, 48= Tarjeta Credito, 49= Tarjeta Debito, mirar los demas en la tabla 13.3.4.2 anexo 1.8, resolucion 12-2021"),
...
PaymentExchangeRate = api.model("PaymentExchangeRate", {
    'SourceCurrencyCode': fields.String(required=False, description="Codigo de la moneda para intercambiar= USD ó EUR, mirar los demas en la tabla 13.3.3 anexo 1.8 resolucion 12"),
    'CalculationRate': fields.String(required=False, description="Tasa de cambio en pesos colombianos= COP"),
    'Date': fields.String(required=False, description="Fecha del intercambio en formato AAAA-MM-DD"),
})
...
IdentificationIssuer = api.model("Identification", {
    ...
    'CountryCode': fields.String(required=True, description="CO= Colombia, ES= España, mirar los demas codigos en la tabla 13.4.1 resolucion 12"),
    'CheckDigit': fields.String(required=False, description="Digito verificacion solo si es NIT"),
})
AddressIssuer = api.model("Address", {
    'DepartmentCode': fields.String(required=True, description="Codigo departamento ej. 76= Valle, 66= Risaralda, mirar los demas en la tabla 13.4.2 Departamentos resolucion 12"),
    'DepartmentName': fields.String(required=False, description="Nombre departamento"),
    'CityCode': fields.String(required=True, description="Codigo ciudad ej. 76001= Cali, 66001= Pereira, mirar en la tabla 13.4.3 Municipios resolucion 12"),
    'CityName': fields.String(required=False, description="Debe ir el nombre de la ciudad"),
    'AddressLine': fields.String(required=False, description="Debe ir la direccion fisica del emisor"),
    'PostalCode': fields.String(required=False, description="Debe ir el codigo postal del emisor"),
    'Country': fields.String(required=True, description="CO= Colombia, ES= España, mirar los demas codigos en la tabla 13.4.1 resolucion 12")
})
IssuerParty = api.model("IssuerParty", {
    ...
    'Name': fields.String(required=True, description="Debe ir el nombre del emisor"),
    'Email': fields.String(required=False, description="Email emisor que tenga registrado en la DIAN"),
    'IndustryClasificationCode': fields.String(required=False, description="Debe ir el codigo actividad economica (CIIU), si son varios van separados con ;"),
    'Address': fields.Nested(AddressIssuer),
    'TaxScheme': fields.String(required=True, description="Debe ir IVA,INC,IVA e INC ó No aplica"),
    'ResponsabilityTypes': fields.String(required=True, description="O-13 Gran contribuyente, O-23 agente retenedor iva, O-47 regimen simple,R-99-PN no aplica, mirar los demas en la tabla 13.2.6.1 resolucion 12-2021")
})
...
LinesDes = api.model("LineDes", {
    ...
    'UnitPrice': fields.String(required=False, description="Precio unitario"),
